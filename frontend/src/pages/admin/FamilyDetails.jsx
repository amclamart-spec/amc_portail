...
const EMPTY_STUDENT = { firstName: '', lastName: '', dateOfBirth: '', gender: 'GARCON', allergies: '', currentTreatments: '', emergencyContactName: '', emergencyContactPhone: '' };
  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <div className="table-container">
          <table>
            <thead><tr><th>Référence</th><th>Total</th><th>Payé</th><th>Statut</th></tr></thead>
            <tbody>
              {(family.payments || []).length === 0 ? (
                <tr><td colSpan="4" style={{ textAlign: 'center', color: '#6B7280' }}>Aucun paiement</td></tr>
              ) : (
                family.payments.map((payment) => (
                  <tr key={payment.id}>
                    ...
                    <td><span className="badge badge-info">{payment.status}</span></td>
                  </tr>
                ))
              )}
            </tbody>
