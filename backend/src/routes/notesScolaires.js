...
router.get('/bulletin/:studentId', authorize('PROFESSEUR', 'FAMILLE', ...POLE_MANAGER_ROLES), actAsClassTeacher, getBulletinUploads);
...
router.get('/:studentId', authorize('PROFESSEUR', 'FAMILLE', ...POLE_MANAGER_ROLES), actAsClassTeacher, getNotes);
